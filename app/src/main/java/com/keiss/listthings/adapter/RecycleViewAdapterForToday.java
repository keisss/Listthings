 ...
 */
public class RecycleViewAdapterForToday extends RecyclerView.Adapter<RecycleViewAdapterForToday.MyViewHolder>   implements onSwipedListener {
    ...
    public RecycleViewAdapterForToday(String[] title,String[] content,int[] things_grade,int[] things_class,String[] things_create_time,String[] things_modify_time){
    ...
    public int getItemCount() {
        ...
        Cursor cursor = db.rawQuery("select * from things where things_create_date_text = ? or things_modify_date_text = ?",new String[]{ThingsCreateDateText,ThingsCreateDateText});
